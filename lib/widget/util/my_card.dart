      ...
      builder: (_, theme,__) {
        return InkWell(
          borderRadius: boxShape != BoxShape.circle
              ...
              : null,
          splashColor: splashColor ?? Colours().trans,
          highlightColor: splashColor ??  Colours().trans,
          onTap: onTap,
          child: Container(
            width: width,
            height: height,
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: boxShape != BoxShape.circle
                    ...
                    : null,
                border: bordered
                    ? border ?? Border.all(color:  Colours().dividerColor(theme.darkTheme), width: 1)
                    : null,
                shape: boxShape ?? BoxShape.rectangle,
                boxShadow: [
                  BoxShadow(
                      color: myShadow.color ??
                          ThemeData().shadowColor.withAlpha(myShadow.alpha),
